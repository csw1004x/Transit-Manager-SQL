  <html>
    ...
    <body>
        ...
        <h2>Insert info for a new transit system</h2>
        <form method="POST" action="transit-system.php"> <!--refresh page when submitted-->
        ...
        function handleInsertManagerQueryRequest() {
            global $db_conn;
            ...
            $tuple = array (
                ...
                ":bind2" => $_POST['managerPassword'],
                ":bind3" => $_POST['firstName'],
                ":bind4" => $_POST['lastName'],
                ":bind5" => TO_DATE($_POST['managerDate'], 'YYYY-MM-DD')
            );
            ...
            executeBoundSQL("insert into manager_id1 values (:bind1, :bind2, :bind3, :bind4, :bind5)", $alltuples);
            OCICommit($db_conn);
        }
        ...
        function handlePOSTRequest() {
            if (connectToDB()) {
                if (array_key_exists('resetTablesRequest', $_POST)) {
                    ...
                    handleInsertManagerQueryRequest();
                }
                disconnectFromDB();
            }
        }
